...
| G-15 | With Yolo mode ON, click **Launch Claude** from the Launch dropdown for any repo | A new terminal window opens; open Task Manager, find the `claude.exe` process, and verify its command line includes `--dangerously-skip-permissions` |
