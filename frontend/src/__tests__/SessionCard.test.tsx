...
describe('SessionCard — thinking preview and tool count', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('shows (redacted) placeholder for redacted thinking in preview', async () => {
    renderCard(makeSession(), [
      makeOutput({ type: 'thinking', role: null, content: '[redacted]', sequenceNumber: 1 }),
    ]);
