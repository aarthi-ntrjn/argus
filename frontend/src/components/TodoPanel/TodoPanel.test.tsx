...
beforeEach(() => {
  ...
  mockUseUpdateTodoText.mockReturnValue(
    makeMutation() as unknown as ReturnType<typeof useUpdateTodoText>,
  );
...
describe('TodoPanel', () => {
  ...
  describe('checkbox toggle', () => {
    it('calls toggleTodo when checkbox is clicked', async () => {
      ...
      mockUseToggleTodo.mockReturnValue(
        makeMutation({ mutate }) as unknown as ReturnType<typeof useToggleTodo>,
      );
      renderPanel();
  ...
  describe('blur saves text', () => {
    it('calls updateTodoText on blur when text has changed', async () => {
      ...
      const mutate = vi.fn();
      mockUseUpdateTodoText.mockReturnValue(
        makeMutation({ mutate }) as unknown as ReturnType<typeof useUpdateTodoText>,
      );
      renderPanel();
      const input = screen.getByRole('textbox', { name: /edit task: First task/i });
      await userEvent.clear(input);
