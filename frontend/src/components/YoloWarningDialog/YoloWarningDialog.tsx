    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-sm mx-4 p-5">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Yolo mode bypasses all permission checks and safety prompts for every session launched
          from Argus. Claude Code will launch with{' '}
          <code className="text-xs bg-gray-100 px-1 rounded">--dangerously-skip-permissions</code>{' '}
          and Copilot will launch with{' '}
          <code className="text-xs bg-gray-100 px-1 rounded">--allow-all</code>.
        </p>
