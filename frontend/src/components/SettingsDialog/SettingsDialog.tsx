    ...
    >
      ...
      >
        ...
        <div className="w-44 bg-gray-50 border-r border-gray-200 flex flex-col p-2 shrink-0">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide px-2 pt-1 pb-2">
            Settings
          </p>
          {TABS.map((t) => (
            <button
          ...
          <div className="px-4 pb-4 pt-9">
            ...
            {tab === 'about' && (
              <div className="flex flex-col gap-1">
                ...
                <DialogLinkItem href="https://github.com/aarthi-ntrjn/argus" icon={<GitHubIcon />}>
                  GitHub
                </DialogLinkItem>
                <DialogLinkItem
            ...
            {tab === 'feedback' && (
              <div className="flex flex-col gap-1">
                ...
                <DialogLinkItem
                  ...
                  icon={<Bug size={13} className="shrink-0" aria-hidden="true" />}
                >
                  Report a Bug
                </DialogLinkItem>
                <DialogLinkItem
                  href={buildFeatureRequestUrl()}
                  icon={<Lightbulb size={13} className="shrink-0" aria-hidden="true" />}
                >
                  Request a Feature
                </DialogLinkItem>
              </div>
