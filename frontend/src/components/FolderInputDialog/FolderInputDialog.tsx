...
export default function FolderInputDialog({
  folderInputPath,
  onPathChange,
  onSubmit,
  onCancel,
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        <h2 id="folder-dialog-title" className="text-lg font-semibold mb-1">
          Add Repositories
        </h2>
        <p className="text-gray-500 text-sm mb-4">
          Enter a root folder path to scan for git repositories.
        </p>
        <input
          autoFocus
          type="text"
