...
const variantClasses: Record<ButtonVariant, string> = {
  primary: 'bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-40 focus-visible:ring-blue-400',
  ...
  outline: 'text-gray-600 border border-gray-300 rounded hover:bg-gray-50 focus-visible:ring-blue-400',
};
