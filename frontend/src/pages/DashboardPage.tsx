          ...
          reposWithSessions.length === 0 ? (
            <div className="flex gap-6 items-start">
              ...
              {!settings.hideTodoPanel && (
                <div className="w-[400px] shrink-0 sticky top-8 flex flex-col" style={{ height: 'calc(100vh - 5rem)' }}>
                  <TodoPanel />
                </div>
              )}
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              {(!settings.hideTodoPanel || selectedSessionId) && (
                <div className={`${selectedSessionId ? 'w-[640px]' : 'w-[400px]'} shrink-0 sticky top-8 flex flex-col gap-4`} style={{ height: 'calc(100vh - 5rem)' }}>
                  {selectedSessionId && (() => {
