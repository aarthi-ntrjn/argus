...
const EVENTS = [
  ...
  {
    name: 'app_ended',
    when: 'The Argus backend server shuts down gracefully (SIGTERM or SIGINT).',
  },
  ...
  {
    name: 'repo_diff_opened',
    when: 'You click the "View diff on GitHub" button for a repository.',
  },
];
    ...
    <div className="min-h-screen bg-slate-50 p-6 md:p-12">
      <div className="mx-auto max-w-5xl">
        <div className="mb-8">
          <button
            onClick={() => navigate('/')}
            className="icon-btn text-sm font-medium text-gray-700 hover:text-blue-600 mb-6 flex items-center gap-1"
          >
            <ArrowLeft size={14} />
            Back
          </button>
        ...
        <section className="bg-white border border-gray-200 rounded-lg p-5 mb-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            <li>
              <span className="font-medium text-gray-900">Approximate location:</span> country and
              region derived from your server's IP address via PostHog's built-in GeoIP enrichment.
            ...
            <li>
              <span className="font-medium text-gray-900">App version:</span> the Argus version
              number (e.g. 0.1.0).
            </li>
            <li>
              <span className="font-medium text-gray-900">Timestamp:</span> when the event occurred
              (UTC).
            </li>
            <li>
              <span className="font-medium text-gray-900">Session ID:</span> a random UUID assigned
              to each session. Not linked to any user or machine.
            </li>
            <li>
              <span className="font-medium text-gray-900">Session type:</span> whether the session
              is Claude Code or Copilot.
            </li>
            <li>
              <span className="font-medium text-gray-900">Launch mode:</span> whether the session
              was launched via Argus (connected) or auto-detected (readonly).
            </li>
            <li>
              <span className="font-medium text-gray-900">Yolo mode:</span> whether the session was
              started with the <span className="font-mono">--dangerously-skip-permissions</span> or{' '}
              <span className="font-mono">--allow-all</span> flags.
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white border border-gray-200 rounded-lg p-5 mb-6">
          ...
          <ul className="space-y-1 text-sm text-gray-700 list-disc list-inside">
            ...
            <li>
              Full IP address or hostname (IP is used transiently for GeoIP lookup but never stored)
            </li>
        ...
        <section className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-sm text-gray-700">
            ...
            <span className="font-medium">Send anonymous usage telemetry</span> under Privacy. No
            events will be sent after that.
          </p>
        </section>
      </div>
    </div>
