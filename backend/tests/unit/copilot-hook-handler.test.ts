...
describe('CopilotCliDetector — handleHookPayload', () => {
  ...
  let detector: import('../../src/cli/copilot/copilot-cli-detector.js').CopilotCliDetector;
  let repoId: string;
  ...
  beforeEach(async () => {
    ...
    const { CopilotCliDetector } = await import('../../src/cli/copilot/copilot-cli-detector.js');
